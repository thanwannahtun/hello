...
class AppTheme {
  static ThemeData lightTheme = ThemeData(
      appBarTheme: const AppBarTheme(
        ...
        color: Color(0xFFFFFFFF), //0xFF10B401
        titleTextStyle: TextStyle(
            color: Colors.green, fontSize: 20, fontWeight: FontWeight.bold),
      ),
      cardTheme: const CardTheme(elevation: 0.2, color: Color(0xFFF9FFF9)
          // shape: Border(left: BorderSide.none, bottom: BorderSide.none),
          ),
      // primaryColor: const Color(0xFFC3E8F6),
      textTheme: const TextTheme(titleLarge: TextStyle(color: Colors.green)),
      elevatedButtonTheme: const ElevatedButtonThemeData(
          style: ButtonStyle(
        elevation: MaterialStatePropertyAll<double?>(null),
