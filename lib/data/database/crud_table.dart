...
import 'package:hello/data/database/base_db_helper.dart';
...
class CRUDTable {
  ...
  /*
  for more than one Databases
  late Database _db;
  final DBHelperInterface _helper = DBHelperInterface.instance;

  CRUDTable(DBHelperInterface helper){
    _helper = helper;
  }
